...
public class DDANegativeSlope extends JFrame implements ActionListener {
    ...
    // Constructor
        public DDANegativeSlope() {
            // Exit out of application
                ...
                setSize(1366,510);
            // Title of the frame
                setTitle("DDA Algo negative Implement");
            Initialization();
        }
    ...
    public void Initialization(){
        ...
        // table for Storing the (x,y) point at every iteration
        ...
        // Add Scrollbar to the Table and Table to the tablePanel
